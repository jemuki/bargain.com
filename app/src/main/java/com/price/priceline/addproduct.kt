...
class addproduct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val back = findViewById<ImageButton>(R.id.adptoback)
    ...
    private fun uploadImage(imageUri: Uri) {
        if(imageUri != null){
            ...
            val ref = storageReference?.child("price_products/" + UUID.randomUUID().toString())
    ...
    private fun uploadall(pimg: ArrayList<String>) {
        ...
        val name = findViewById<EditText>(R.id.apname)
        val price = findViewById<EditText>(R.id.apprice)
        val location = findViewById<EditText>(R.id.aploc)
        val desc = findViewById<EditText>(R.id.apdesc)
        ...
        //post it to api
        client.post(this, "http://coding.co.ke/jereson/addpriceproduct",
