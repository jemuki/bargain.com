...
class MyproductAdapter(var context: Context, productList: ArrayList<ProductModel>):
    ...
    override fun onBindViewHolder(holder: MyproductAdapter.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            //intent
            val x = Intent(context, mysingleproduct::class.java)
    ...
    private fun delpro(id: String) {
        ...
        //post it to api
            client.post(context, "http://coding.co.ke/jereson/delpriceproduct",
